...
finish = Game_sprite(90, 240, 40, 60, r'images\frukt.png')
finish2 = Game_sprite(90, 240, 40, 60, r"images\Mochi.png")
finish3 = Game_sprite(90, 240, 40, 60, r"images\frukt2.png")

walls = pygame.sprite.Group()
wall1 = Game_sprite(85, 6, 5, 300, r'images\wol.jpg') 
walls.add(wall1)
wall2 = Game_sprite(85, 306, 250, 5, r'images\wol.jpg')
walls.add(wall2)
wall3 = Game_sprite(550, 306, 250, 5, r'images\wol.jpg')
walls.add(wall3)
wall4 = Game_sprite(100, 500, 5, 300, r'images\wol.jpg')
walls.add(wall4)
wall5 = Game_sprite(0, 500, 110, 5, r'images\wol.jpg')
walls.add(wall5)
wall6 = Game_sprite(550, 306, 5, 250, r'images\wol.jpg')
walls.add(wall6)
